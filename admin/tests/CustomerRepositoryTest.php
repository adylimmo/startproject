...
class CustomerRepositoryTest extends TestCase
{
    ...
    public function testReadCustomer()
    {
        ...
        $dbCustomer = $this->customerRepo->find($customer->customer_id);
    ...
    public function testUpdateCustomer()
    {
        ...
        $updatedCustomer = $this->customerRepo->update($fakeCustomer, $customer->customer_id);
    ...
    {
        $customer = $this->makeCustomer();
        $resp = $this->customerRepo->delete($customer->customer_id);
        $this->assertTrue($resp);
        $this->assertNull(Customer::find($customer->customer_id), 'Customer should not exist in DB');
    }
}
