...
class SalesRepositoryTest extends TestCase
{
    ...
    public function testReadSales()
    {
        ...
        $dbSales = $this->salesRepo->find($sales->sales_id);
    ...
    public function testUpdateSales()
    {
        ...
        $updatedSales = $this->salesRepo->update($fakeSales, $sales->sales_id);
    ...
    {
        $sales = $this->makeSales();
        $resp = $this->salesRepo->delete($sales->sales_id);
        $this->assertTrue($resp);
        $this->assertNull(Sales::find($sales->sales_id), 'Sales should not exist in DB');
    }
}
