...
class ActivityController extends AppBaseController
{
    ...
    public function index(Request $request)
    {
        ...
        $activities = $this->activityRepository->with('task')->all();
    ...
    {
        foreach ($taskRepository->all() as $task) {
            $tasks[$task->task_id] = $task->task_title;
        }
     ...
     * @return Response
     */
    public function edit(TaskRepository $taskRepository, $id)
    {
        $activity = $this->activityRepository->findWithoutFail($id);
