...
class TaskRepositoryTest extends TestCase
{
    ...
    {
        $task = $this->makeTask();
        $dbTask = $this->taskRepo->find($task->task_id);
    ...
    public function testUpdateTask()
    {
        ...
        $updatedTask = $this->taskRepo->update($fakeTask, $task->task_id);
    ...
    {
        $task = $this->makeTask();
        $resp = $this->taskRepo->delete($task->task_id);
        $this->assertTrue($resp);
        $this->assertNull(Task::find($task->task_id), 'Task should not exist in DB');
    }
}
