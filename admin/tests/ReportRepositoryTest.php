...
class ReportRepositoryTest extends TestCase
{
    ...
    public function testReadReport()
    {
        ...
        $dbReport = $this->reportRepo->find($report->report_id);
    ...
    public function testUpdateReport()
    {
        ...
        $updatedReport = $this->reportRepo->update($fakeReport, $report->report_id);
    ...
    {
        $report = $this->makeReport();
        $resp = $this->reportRepo->delete($report->report_id);
        $this->assertTrue($resp);
        $this->assertNull(Report::find($report->report_id), 'Report should not exist in DB');
    }
}
