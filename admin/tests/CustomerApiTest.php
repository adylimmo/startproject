...
class CustomerApiTest extends TestCase
{
    ...
    public function testReadCustomer()
    {
        ...
        $this->json('GET', '/api/v1/customers/'.$customer->customer_id);
    ...
    public function testUpdateCustomer()
    {
        ...
        $this->json('PUT', '/api/v1/customers/'.$customer->customer_id, $editedCustomer);
    ...
    {
        $customer = $this->makeCustomer();
        $this->json('DELETE', '/api/v1/customers/'.$customer->icustomer_idd);
